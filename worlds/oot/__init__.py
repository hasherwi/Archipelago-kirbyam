...
from typing import AbstractSet, List, Optional, Union  # remove when 3.8 support is dropped

import settings

logger = logging.getLogger("Ocarina of Time")

from BaseClasses import CollectionState, LocationProgressType, MultiWorld, Tutorial
from Fill import FillError, fast_fill, fill_restrictive
from Options import Accessibility, PlandoConnections, PlandoItems, Range, Toggle, VerifyKeys
from worlds.AutoWorld import AutoLogicRegister, WebWorld, World
from worlds.generic.Rules import add_item_rule, exclusion_rules

from .Cosmetics import patch_cosmetics
from .DungeonList import create_dungeons, dungeon_table
from .Entrance import OOTEntrance
from .EntranceShuffle import EntranceShuffleError, entrance_shuffle_table, shuffle_random_entrances
from .HintList import getRequiredHints
from .Hints import HintArea, HintAreaNotFound, buildWorldGossipHints, get_hint_area, hint_dist_keys
...
from .Location import LocationFactory, OOTLocation, build_location_name_groups, location_name_to_id
from .LocationList import business_scrubs, dungeon_song_locations, set_drop_location_names
