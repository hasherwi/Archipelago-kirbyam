...
- AP ability unlock items are generated dynamically from `data/abilities.json` for every copyable ability. Abilities marked `safe_to_gate` are blocked until their matching AP unlock item has been received.
