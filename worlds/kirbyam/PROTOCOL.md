...
- `ability_randomization_minny` (bool): include/exclude Minny from copy-ability randomization. Enemy and statue randomization both respect this toggle when enabled.
