...
- `ability_randomization_statues` (bool): include/exclude ability statues/stands from copy-ability randomization. This option controls inclusion only; included statues inherit `ability_randomization_mode` (`off`, `shuffled`, `completely_random`).
